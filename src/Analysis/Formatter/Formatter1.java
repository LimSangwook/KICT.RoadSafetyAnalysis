...
public class Formatter1 {
	...
	private String getHeaderOfTotalInfo() {
		return "총 추종개수,주행추종개수,선행간추종개수,총 제한속도 초과,총 안전속도 초과,총 SDI 위험 개수,총 TTC 초과(3초 기준) 개수,총 종합판단에 따른 위험판단 개수, 가속도(m/s^2),EXP FCRI,WeightedAverage FCRI, Uniform FCRI, Triweight FCRI, Gaussian FCRI,근접IC";
	}
