...
public class RadarDataModel {
	...
	public double getCalACCEL() {
		return calACCEL;
	}
	public void setCalACCEL(double calACCEL) {
		this.calACCEL = calACCEL;
	}

	private double speed;
	private double distance = -1;
	private ArrayList<TrackData> trackDatas;
	private double calACCEL;
	
	public class TrackData {
		public double X;			// 단위 : m		
		public double Y;			// 단위 : m
		public double RangeRate;	// 단위 : m/s
		public double RangeAccel;	
	...
	public void SetTrackData(int index, double X, double Y, double RangeRate, double RangeAccel){
		TrackData trackData = trackDatas.get(index);
		trackData.X = X;
		trackData.Y = Y;
		trackData.RangeRate = RangeRate;
		trackData.RangeAccel = RangeAccel;
	}
	...
	public void MergeSameGPSTime(RadarDataModel newData) {
